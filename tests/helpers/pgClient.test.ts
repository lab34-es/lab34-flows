import pg from 'pg';
import * as pgClient from '../../src/helpers/pgClient';
...
describe('pgClient', () => {
  ...
  beforeEach(() => {
    ...
    pg.Client = jest.fn(() => mockClient) as unknown as typeof pg.Client;
  ...
  describe('Error handling', () => {
    ...
    it('should handle timeout errors', async () => {
      ...
      (timeoutError as NodeJS.ErrnoException).code = 'QUERY_TIMEOUT';
  ...
  describe('Connection lifecycle', () => {
    ...
    it('should not reuse connections between queries', async () => {
      ...
      (pg.Client as unknown as jest.Mock)
