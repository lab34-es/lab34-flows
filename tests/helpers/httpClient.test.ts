...
import * as httpClient from '../../src/helpers/httpClient';
import { createReporterMock } from '../mocks/reporter.mock';
...
describe('httpClient', () => {
  ...
  describe('GET requests', () => {
    it('should make a successful GET request', async () => {
      ...
      const [_headers, status, body] = await httpClient.get(ctx, '/users');
  ...
  describe('POST requests', () => {
    it('should make a POST request with JSON data', async () => {
      ...
      const [_headers, status, body] = await httpClient.post(ctx, '/users', {
        data: postData
      });
  ...
  describe('PUT requests', () => {
    it('should make a PUT request', async () => {
      ...
      const [_headers, status, body] = await httpClient.put(ctx, '/users/1', {
        data: putData
      });
  ...
  describe('DELETE requests', () => {
    it('should make a DELETE request', async () => {
      ...
      const [_headers, status, body] = await httpClient.del(ctx, '/users/1');
  ...
  describe('PATCH requests', () => {
    it('should make a PATCH request', async () => {
      ...
      const [_headers, status, body] = await httpClient.patch(ctx, '/users/1', {
        data: patchData
      });
  ...
  describe('Error handling', () => {
    ...
    it('should return HTTP error responses as regular responses', async () => {
      ...
      (axios.request as jest.Mock).mockRejectedValue(errorResponse);
  ...
  describe('Response formatting', () => {
    it('should handle JSON responses correctly', async () => {
      ...
      const [_headers, status, body] = await httpClient.get(ctx, '/json');
    ...
    it('should handle non-JSON responses', async () => {
      ...
      const [_headers, status, body] = await httpClient.get(ctx, '/html');
    ...
    it('should handle empty response body', async () => {
      ...
      const [_headers, status, body] = await httpClient.get(ctx, '/empty');
