 ...
 * @returns {Promise<{flow: string, format: string, provider: string, model: string}>}
 */
module.exports.edit = async (body) => {
  const prompt = (body && body.prompt ? String(body.prompt) : '').trim();
...
module.exports.unwrapDocument = unwrapDocument;
module.exports.validateDocument = validateDocument;
module.exports.buildCreatePrompt = buildCreatePrompt;
module.exports.buildEditPrompt = buildEditPrompt;
