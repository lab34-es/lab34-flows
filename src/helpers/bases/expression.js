...
const VALUE_METHODS = {
  ...
  slice: (receiver, start, end) => (
    Array.isArray(receiver)
      ? receiver.slice(toNumber(start) ?? 0, end === undefined ? undefined : toNumber(end))
      : toText(receiver).slice(toNumber(start) ?? 0, end === undefined ? undefined : toNumber(end))
  ),
...
module.exports = {
  ...
  evaluate,
  test,
  // Coercions, shared with the view evaluator
  compare,
  contains,
  formatDate,
  isEmpty,
